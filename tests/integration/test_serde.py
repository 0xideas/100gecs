...
def test_serde_gec(
    lightgec, lightgec_is_serialised, lightgec_serialisation_path, X, y_class
):
...
def test_serde_ger(
    lightger, lightger_is_serialised, lightger_serialisation_path, X, y_real
):
...
def test_serde_catgec(
    catgec, catgec_is_serialised, catgec_serialisation_path, X, y_class
):
...
def test_serde_catger(
    catger, catger_is_serialised, catger_serialisation_path, X, y_class
):
